    ...
    const char *settings)
{
    ...
    params.set("scene-mode-values", "auto,beauty,landscape,snow,beach,sunset,night,portrait,backlight,sports,"
            "flowers,candlelight,fireworks,party,night-portrait");
...
static int camera_device_close(hw_device_t *device)
{
    ...
    wrapper_dev->vendor->common.close((hw_device_t *)wrapper_dev->vendor);    if (wrapper_dev->base.ops)
